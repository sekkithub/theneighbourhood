/**
 * @license AngularJS v1.3.1-local+sha.fatal: Needed a single revision
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.1-local+sha.fatal: Needed a single revision/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.1-local+sha.fatal: Needed a single revision',    // all of these placeholder strings will be replaced by grunt's
